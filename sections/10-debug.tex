...
\lstinputlisting[language=bash]{codes/10-debug-01.sh}
...
\textbf{调试流程：}
\begin{enumerate}
  \item \textbf{编译：} \code{g++ -g -Wall -O0 -o debug 10-debug-02.cpp}
...
\lstinputlisting[language=bash]{codes/10-debug-02.gdb}
