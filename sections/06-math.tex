...
\lstinputlisting[language=C++]{codes/06-math-01.cpp}
...
\lstinputlisting[language=C++]{codes/06-math-02.cpp}
...
\lstinputlisting[language=C++]{codes/06-math-16.cpp}
...
\lstinputlisting[language=C++]{codes/06-math-09.cpp}
...
\lstinputlisting[language=C++]{codes/06-math-10.cpp}

\textbf{说明：}
\begin{itemize}
    \item 代码自包含（内嵌与 06-math-02 相同的 NTT），可整文件复制到比赛工程中使用。
...
\lstinputlisting[language=C++]{codes/06-math-11.cpp}
...
\lstinputlisting[language=C++]{codes/06-math-12.cpp}
...
\lstinputlisting[language=C++]{codes/06-math-13.cpp}
...
\lstinputlisting[language=C++]{codes/06-math-03.cpp}
...
\lstinputlisting[language=C++]{codes/06-math-04.cpp}
...
\lstinputlisting[language=C++]{codes/06-math-05.cpp}
...
\lstinputlisting[language=C++]{codes/06-math-06.cpp}
...
\lstinputlisting[language=C++]{codes/06-math-07.cpp}
...
\lstinputlisting[language=C++]{codes/06-math-19.cpp}
...
\lstinputlisting[language=C++]{codes/06-math-17.cpp}
...
\lstinputlisting[language=C++]{codes/06-math-18.cpp}
...
\lstinputlisting[language=C++]{codes/06-math-14.cpp}
...
\lstinputlisting[language=C++]{codes/06-math-15.cpp}
